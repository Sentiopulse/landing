    ...
    <section className="w-full flex flex-col items-center justify-center py-20 px-4 bg-[var(--custom-card-color-two)]">
      ...
      <div className="w-full max-w-6xl grid md:grid-cols-2 gap-6 mt-6">
          ...
          <CardContent className="flex justify-start w-full ">
            <ul className="text-md text-foreground space-y-4 text-left pl-6">
              <li className="flex items-center gap-2">
                <span className="text-[var(--custom-green)]"><FaCheck size={20}/></span> Weekly
                newsletter with key insights
              </li>
              <li className="flex items-center gap-2">
                <span className="text-[var(--custom-green)]"><FaCheck size={20}/></span> Daily
                sentiment posts on Twitter/X
              </li>
              <li className="flex items-center gap-2">
                <span className="text-[var(--custom-green)]"><FaCheck size={20}/></span> Access to
                public sentiment feed
              </li>
              <li className="flex items-center gap-2">
                <span className="text-[var(--custom-green)]"><FaCheck size={20}/></span> Basic
                market coverage (BTC, ETH, SPY)
              </li>
              <li className="flex items-center gap-2">
                <span className="text-[var(--custom-green)]"><FaCheck size={20}/></span> Community
                support
              </li>
            </ul>
          </CardContent>
        ...
        <Card className="relative rounded-2xl border border-[var(--custom-green)] bg-[var(--custom-card-color)] shadow-[0_0_20px_rgba(33,143,88,0.5)] backdrop-blur-xl p-7 flex flex-col items-center gap-5 h-[650px] w-[95%] -mt-6">
          ...
          <CardHeader className="flex flex-col items-center gap-6 relative">
            <CardTitle className="flex flex-col justify-center items-center">
              <span className="inline-flex h-18 w-18 items-center justify-center rounded-full bg-[linear-gradient(135deg,var(--custom-blue)_0%,var(--custom-purple)_40%,var(--custom-green)_90%)] shadow mt-2">
                <Crown size={35} className="text-background" />
              </span>
              <h3 className="font-bold text-4xl text-foreground mt-4">
                Premium
              </h3>
              <p className="text-4xl font-bold text-foreground whitespace-nowrap mt-2">
                $29
          ...
          <CardContent className="flex justify-start w-full">
            <ul className="text-md text-foreground space-y-3 text-left pl-6">
              <li className="flex items-center gap-2">
                <span className="text-[var(--custom-green)]"><FaCheck size={20}/></span> Real-time
                email alerts for custom assets
              </li>
              <li className="flex items-center gap-2">
                <span className="text-[var(--custom-green)]"><FaCheck size={20}/></span>{" "}
                Interactive dashboard with filtering
              </li>
              <li className="flex items-center gap-2">
                <span className="text-[color:var(--custom-green)]"><FaCheck size={20}/></span>{" "}
              ...
              <li className="flex items-center gap-2">
                <span className="text-[var(--custom-green)]"><FaCheck size={20}/></span> API
                access (coming soon)
              </li>
              <li className="flex items-center gap-2">
                <span className="text-[var(--custom-green)]"><FaCheck size={20}/></span> Priority
                support
              </li>
            </ul>
          </CardContent>
