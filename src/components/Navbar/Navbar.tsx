...
export default function Navbar() {
  return (
    <nav className="sticky top-0 flex flex-col md:flex-row items-center justify-between bg-transparent backdrop-blur-md font-sans border-b shadow-lg mb-6 px-6 z-50">
